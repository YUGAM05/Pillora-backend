...
import { registerDonor, findDonors, createRequest, getRequests, getAllDonors, getAllRequestsAdmin, updateRequestStatus, findMatches, deleteDonor, deleteRequest, deleteMyRequest, getMyRequests, getMyDonorProfile, verifyRequestWithAI, updateKycStatus, updateDonorAdmin, deleteManyDonors } from '../controllers/bloodBankController';
...
router.post('/admin/donors/delete-many', protect, adminOnly, deleteManyDonors);
