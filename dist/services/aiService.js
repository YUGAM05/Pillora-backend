...
const verifyPrescription = (ocrText) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log('API Key preview:', apiKey === null || apiKey === void 0 ? void 0 : apiKey.substring(0, 15));
    if (!apiKey || apiKey === '') {
...
"""`;
    try {
        ...
        for (const word of medicalKeywords) {
            if (new RegExp(`\\b${word}\\b`, 'i').test(ocrText))
                matchCount++;
        }
 ...
 */
function getSimulatedResponse(ocrText = '') {
