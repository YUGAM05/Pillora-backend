...
exports.sendPasswordResetEmail = exports.sendDonorFoundEmail = exports.sendNoDonorFoundEmail = exports.sendKYCFailedEmail = exports.sendPrescriptionEmail = exports.sendInvoiceEmail = exports.sendHospitalNotificationEmail = exports.sendBookingConfirmationEmail = exports.verifyEmailTransporter = void 0;
 ...
 */
const verifyEmailTransporter = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const sendPasswordResetEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ toEmail, name, resetLink }) {
    if (!toEmail) {
